...
namespace AppMvcBasica.Controllers
{
    ...
    public class ProdutosController : Controller
    {
        ...
        {
            ViewData["FornecedorId"] = new SelectList(_context.Forncedores, "Id", "Nome");
            return View();
        }
        ...
        public async Task<IActionResult> Create(Produto produto)
        {
            ...
            ViewData["FornecedorId"] = new SelectList(_context.Forncedores, "Id", "Nome", produto.FornecedorId);
            return View(produto);
        }
